...
#ifndef H_CRYPTOGRAPHICANOMALY_SCRIPT
#define H_CRYPTOGRAPHICANOMALY_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCryptographicanomalyAddress
 */
...
public:
    ...
    // Pre-version-0.6, Cryptographicanomaly always counted CHECKMULTISIGs
