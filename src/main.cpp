...
{        
    ...
    if(block <= 10 ) // So developer can pay bounties to further the development of CGA
        {
        ...
        else if(remain == 100) // Pools should be shooting for this reward ;)
        	{
            nSubsidy = 100 * COIN;
            }
    	}
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb54f0e1364b41ba1f0cbcbc2f88554f9d09e28507063b63bc3ebdd19601a47e2");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        if (fTestNet)
        {
            block.nTime    = 1390166027;
            block.nNonce   = 385671204;
        }
