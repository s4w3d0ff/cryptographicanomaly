    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new CryptographicanomalyUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->cryptographicanomalyAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Cryptographicanomaly."), QMessageBox::Ok);
