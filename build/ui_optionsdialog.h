...
#include "cryptographicanomalyamountfield.h"
...
public:
    ...
    CryptographicanomalyAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_1_Main;
    QCheckBox *cryptographicanomalyAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new CryptographicanomalyAmountField(tabMain);
        ...
        cryptographicanomalyAtStartup = new QCheckBox(tabMain);
        cryptographicanomalyAtStartup->setObjectName(QString::fromUtf8("cryptographicanomalyAtStartup"));

        verticalLayout_Main->addWidget(cryptographicanomalyAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        cryptographicanomalyAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Cryptographicanomaly after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        cryptographicanomalyAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Cryptographicanomaly on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Cryptographicanomaly client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Cryptographicanomaly network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Cryptographicanomaly.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show Cryptographicanomaly addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
