...
unlocked to sign the Cryptographicanomaly-Qt.app bundle.
...
allowing somebody to distribute a Cryptographicanomaly-Qt.app or cryptographicanomaly-qt-setup.exe with a valid
...
that the cryptographicanomaly-qt.exe file inside the installer had not been tampered with.
